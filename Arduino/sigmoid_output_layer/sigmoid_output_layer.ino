...
// cost- how much you were off the target
//output layer 
// derivative of the cost/error
float dcost_dpred = 2* (output - target);

Serial.print("dcost_dpred = ");
Serial.println(dcost_dpred);

//bring derivative through sigmoid (output was calculated through sigmoid)
float dpred_dz = output * (1.0 - output);
...
Serial.print("pass this error amout to hidden2 neuron0: ");
Serial.println(dcost_input1,4);
Serial.print("pass this error amout to hidden2 neuron1: ");
