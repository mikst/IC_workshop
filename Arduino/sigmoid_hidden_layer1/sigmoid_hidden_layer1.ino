...
input1 = input1/1023.0;
input2 = input2/1023.0;
input3 = input3/1023.0;
input4 = input4/1023.0;
...
void forwardProp(){
  float temp = my_weight1 * input1 + my_weight2 * input2 + my_weight3 * input3 + my_weight4 * input4 + my_bias ;
...
float dcost_dw_3=dcost_dpred*dpred_dz*input3;
float dcost_dw_4=dcost_dpred*dpred_dz*input4;
...
Serial.print("float my_weight3 = ");
Serial.println(my_weight3,4); 
Serial.print("float my_weight4 = ");
Serial.println(my_weight4,4); 
